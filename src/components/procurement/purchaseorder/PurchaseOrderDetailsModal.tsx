    ...
    <>
      ...
      <div
        style={{
          ...
          animation: "podm-slide .2s cubic-bezier(.4,0,.2,1)",
          overflow: "hidden",
        }}
      >
        <style>{`
          @keyframes podm-fade  { from{opacity:0}to{opacity:1} }
          @keyframes podm-slide { from{transform:translateX(48px);opacity:0}to{transform:translateX(0);opacity:1} }
          @keyframes podm-up    { from{transform:translateY(16px);opacity:0}to{transform:translateY(0);opacity:1} }
          @keyframes podm-spin  { to{transform:rotate(360deg)} }
          .podm-btn {
          ...
          .podm-btn:hover  { opacity:.85; transform:translateY(-1px) }
          .podm-btn:active { transform:translateY(0) }
          .podm-irow { transition: background .1s }
          .podm-irow:hover { background: var(--row-hover) }
          .podm-trow:hover { background: var(--row-hover) }
        `}</style>
          ...
          {loading && (
            ...
            >
              <svg
                ...
                stroke="var(--primary)"
                strokeWidth="2"
                style={{ animation: "podm-spin 1s linear infinite" }}
              >
        ...
        {(pdfUrl || pdfLoading) && (
          <div
            style={{
              ...
              display: "flex",
              flexDirection: "column",
              animation: "podm-up .18s cubic-bezier(.4,0,.2,1)",
            }}
          >
            <div
              style={{
