...
const SalesOrderDetailModal: React.FC<Props> = ({
  ...
  const taxTotal = data?.total_tax ?? data?.totalTax ?? 0;
          ...
          {loading && (
            ...
            >
              <svg
                ...
                stroke="var(--primary)"
                strokeWidth="2"
                style={{ animation: "sodm-spin 1s linear infinite" }}
              >
            ...
            <>
              ...
              {(data.customerPoNo || data.orderType || data.customerPoDate) && (
                ...
                >
                  ...
                  {data.customerPoNo && (
                    <F label="Customer PO No." value={data.customerPoNo} mono />
                  )}
                  {data.customerPoDate && (
                    <F
                      label="Customer PO Date"
                      value={fmtDate(data.customerPoDate)}
                    />
                  )}
                </div>
              )}
        ...
        {(pdfUrl || pdfLoading) && (
          <div
            style={{
              ...
              display: "flex",
              flexDirection: "column",
              animation: "sodm-up .18s cubic-bezier(.4,0,.2,1)",
            }}
          >
            <div
              style={{
