          ...
          {loading && (
            ...
            >
              <svg
                ...
                stroke="var(--primary)"
                strokeWidth="2"
                style={{ animation: "pdm-spin 1s linear infinite" }}
              >
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  >
                    {fmtDate(data.postingDate ?? data.dateofinvoice)}
                  </p>
                </div>
                <div
                  style={{
              ...
              {(data.lpoNumber || data.invoiceType || data.taxCategory) && (
                ...
                >
                  <F
                    label="Invoice Type"
                    value={data.invoiceType ?? data.taxCategory}
                  />
                  {data.lpoNumber && (
        ...
        {(pdfUrl || pdfLoading) && (
          <div
            style={{
              ...
              display: "flex",
              flexDirection: "column",
              animation: "pdm-up .18s cubic-bezier(.4,0,.2,1)",
            }}
          >
            <div
              style={{
