...
// import { fetchImportedPurchaseInvoiceDetail } from "../../../api/procurement/Importedpurchaseinvoice.api";
// import type {
...
// interface Props {
//   invoice: ImportedPurchaseInvoiceItemRaw;
//   onClose: () => void;
//   onViewPdf?: () => void;
// }
...
// const PurchaseInvoiceDetailsDrawer: React.FC<Props> = ({
//   invoice,
//   onClose,
//   onViewPdf,
// }) => {
//   const [detail, setDetail] = useState<ImportedPurchaseInvoiceDetailRaw | null>(
//     null,
//   );
...
//       setError(null);
//       try {
//         const data = await fetchImportedPurchaseInvoiceDetail(invoice.name!);
...
//   const d: ImportedPurchaseInvoiceItemRaw | ImportedPurchaseInvoiceDetailRaw =
//     detail ?? invoice;
...
//             {(d.mapped_purchase_invoice || d.status) && (
//               <div
//                 style={{
//                   display: "flex",
//                   alignItems: "center",
...
//                     : "—",
//               },
//               { label: "Record ID", val: detail?.name ?? invoice.name },
//             ].map((log, idx, arr) => (
//               <div
//                 key={idx}
//                 style={{
...
// export default PurchaseInvoiceDetailsDrawer;