...
import { ExternalLink, Download, Loader2, X, ZoomIn, ZoomOut, RotateCw } from "lucide-react";
...
const PdfViewerModal: React.FC<PdfViewerProps> = ({ blobUrl, title, onClose, onDownload }) => {
  // Close on Escape
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: "min(900px, 95vw)", height: "min(92vh, 900px)", zIndex: 10000 }}
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-theme bg-app shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-semibold text-main leading-tight">{title}</p>
