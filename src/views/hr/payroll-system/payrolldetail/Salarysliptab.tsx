...
const KpiCard: React.FC<KpiCardProps> = ({
  ...
  >
    ...
    <p
      ...
      style={valueStyle ?? { color: "var(--text)" }}
    >
      {value}
    </p>
    {sub && (
          ...
          <>
            ...
            >
              <div
                ...
                style={{ width: `${eBarPct}%`, backgroundColor: earningColor }}
              />
            </div>
            {/* Amount */}
            <span
              className="text-xs font-semibold shrink-0 w-24 text-right"
        ...
        >
          {["Earnings", "Deductions"].map((side) => (
            <div key={side} className="flex items-center gap-2 px-3 py-1.5">
              <span
                className="text-[9px] font-semibold uppercase tracking-wider w-7"
                style={{ color: "var(--muted)" }}
              >
                Abbr
              </span>
              ...
              <span
                className="w-24 text-[9px] font-semibold uppercase tracking-wider text-right"
                style={{ color: "var(--muted)" }}
              >
                Amount
              </span>
      ...
      >
        {isNonTaxable ? (
          <p className="text-xs py-3" style={{ color: "var(--muted)" }}>
            Tax not applicable for this payroll period. All earnings are
            ...
            {(
              [
                ...
                { key: "non_taxable_earnings", label: "Non-taxable earnings" },
                {
                  ...
                  label: "Standard tax exemption",
                },
                {
                  key: "tax_exemption_declaration",
                  label: "Tax exemption declaration",
                },
                {
                  key: "deductions_before_tax_calculation",
                  label: "Deductions before tax",
                },
                {
                ...
                {
                  key: "future_income_tax_deductions",
