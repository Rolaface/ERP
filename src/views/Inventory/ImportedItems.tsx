...
import { openProcessImportModal } from "../../components/feature/inventory/processImport.modal";
import SupplierSelect from "../../components/selects/procurement/SupplierSelect";
...
const ImportedItem: React.FC = () => {
  ...
  const [selectedDeclaration, setSelectedDeclaration] =
    useState<ImportedDeclarationItemRaw | null>(null);
